...
class GameApi(gamesService: GameService)(implicit cs: ContextShift[Task], s: Scheduler) {
  ...
  val joinGame: Endpoint[GameId, PlayerJoinError, GameApiDto, Nothing] = endpoint
    .put
